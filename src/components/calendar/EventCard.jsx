...
const EventCard = ({ event, onEdit, onDelete }) => {
    ...
    return (
        ...
        >
            ...
            >
                {isDeadline ? <Bell size={24} className="text-amber-400" /> : <Clock size={24} className="text-cyan-400" />}
            </div>
            ...
            <div className="flex flex-col items-end gap-2 flex-shrink-0">
                ...
                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button onClick={onEdit} className="p-1.5 rounded-md hover:bg-white/10 text-slate-400 hover:text-cyan-300">
                        <Edit size={16} />
                    </button>
                    <button onClick={onDelete} className="p-1.5 rounded-md hover:bg-white/10 text-slate-400 hover:text-red-400">
                        <Trash2 size={16} />
                    </button>
                </div>
            </div>
