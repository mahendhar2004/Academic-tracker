...
const PersonalDetails = ({ profileData, onSave }) => {
    ...
    return (
        <div className="bg-white/10 saturate-150 backdrop-blur-xl border border-white/20 p-6 rounded-xl shadow-lg">
            <div className="space-y-4">
                ...
                <motion.button whileTap={{ scale: 0.95 }} onClick={() => onSave(details)} className="w-full bg-cyan-500/50 hover:bg-cyan-500/80 border border-cyan-400/50 text-white font-bold py-3 px-4 rounded-lg transition-colors">
                    Save Details
                </motion.button>
            </div>
        </div>
