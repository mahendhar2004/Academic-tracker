        ...
        <GlassyModal isOpen={isOpen} onClose={onClose} title="Delete Account" customClasses="border-red-500/50 bg-red-900/10">
            <div className="space-y-6 text-center max-w-sm">
                ...
                <input
                    ...
                    className="w-full bg-black/20 border border-white/20 rounded-lg px-4 py-3 text-center text-lg tracking-[0.2em] focus:outline-none focus:ring-2 focus:ring-red-400"
                />
                <motion.button 
                    whileTap={{scale: 0.95}} 
                    onClick={onConfirm}
