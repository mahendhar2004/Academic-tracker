...
const AttendanceCard = ({ course, onMarkAttendance, onTotalChange, onDecrementAttendance, onDelete, onToggleVisibility, isCurrentSemester }) => {
    const { name, attended = 0, total = 0, isHidden = false } = course;
