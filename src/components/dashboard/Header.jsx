...
import { Plus, Coins, CalendarDays, Timer } from 'lucide-react'; // Import Timer

const Header = ({ currentPage, profileData, onAddNewCourse, onOpenTimetable, onOpenPomodoro }) => { // Add onOpenPomodoro
    return (
        <header className="flex justify-between items-center mb-12">
            ...
            <div className="flex items-center gap-4">
                ...
                {/* New Pomodoro Button */}
                <motion.button whileTap={{ scale: 0.95 }} onClick={onOpenPomodoro} className="flex-shrink-0 flex items-center justify-center bg-white/15 backdrop-blur-xl border border-white/25 text-white w-10 h-10 rounded-lg transition-colors hover:bg-white/25">
                    <Timer size={20} />
                </motion.button>
